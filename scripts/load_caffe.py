...
model_def = os.path.join(caffe_root ,'/tmp/pet/deploy.prototxt')
model_weights = os.path.join(caffe_root ,'/tmp/pet/model_iter_280000.caffemodel')

net = caffe.Net(model_def,      # defines the structure of the model
                model_weights,  # contains the trained weights
                caffe.TEST)     # use test mode (e.g., don't perform dropout)
mu = np.load(os.path.join(caffe_root , '/home/liushuai/caffe/scripts/mean.npy'))
...
image_path = '/tmp/pet/val/german_shorthaired_79.jpg'
print(image_path)
